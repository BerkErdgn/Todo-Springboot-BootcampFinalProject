...
// @SpringBootApplication
public class TodoSpringbootBootcampFinalProjectApplication {
	...
	public static void main(String[] args) {
		 ...
		 * SpringApplication(TurgutUniversitySpringAllInOneApplication.class);
		...
		// Main
		SpringApplication.run(TodoSpringbootBootcampFinalProjectApplication.class, args);
	} // end PSVM
